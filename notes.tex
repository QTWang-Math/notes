...
\begin{proof}
  There is a proof in \cite{HTT}, I don't want to repeat it here.  
\end{proof}
...
\[\cdots \subseteq F^{i}_j{\bullet} \subseteq F^i_{j+1}K^{\bullet} \subseteq \cdots \subseteq F^i.\]
...
\begin{rk}
  The key point is the result of Joseph \cite{Jos} the Springer correspondence of cell representation gives the annihilator variety. However, I'm not fully understand the details.
\end{rk}
...
\begin{thebibliography}{99}
    ...
    \bibitem[Nev]{Nev}
    M. Nevins, Admissible nilpotent coadjoint orbits of $p$-adic reductive Lie groups, Represent. Theory {\bf 3} (1999), 105--126; MR1698202

    \bibitem[Sch]{Sch}
    J.~O. Schwartz, {\it THE DETERMINATION OF THE ADMISSIBLE NILPOTENT ORBITS IN REAL CLASSICAL GROUPS}, ProQuest LLC, Ann Arbor, MI, 1987; MR2941135

    \bibitem[HTT]{HTT}
    R. Hotta, K. Takeuchi, and T. Tanisaki. \textit{D-Modules, Perverse Sheaves, and Representation Theory}, Progress in Mathematics, vol. 236, Birkhäuser Boston, Inc., Boston, MA, 2008.
