...
\[
  \BR p_{\CN,*}\underline{\BQ}_{\tilde{\CN}} \simeq (\BR p_{*}\underline{\BQ}_{\tilde{\fg}})|_{\CN}. \qquad \textcolor{red}{(Springer \ sheaf)}
\]
So there is a natural $W$-action on $\BR p_{\CN,*}\underline{\BQ}_{\tilde{\CN}}$ and hence on $H^{\bullet}_c(T^*\CB,\BQ) \simeq \BR \Gamma_c(\CN,\BR p_{\CN,*}\underline{\BQ}_{\tilde{\CN}})$ and $H^{\bullet}_c(\CB_x,\BQ) \simeq \BR \Gamma_c(\{ x \}, \BR p_{\CN,*}\underline{\BQ}_{\tilde{\CN}})$. (action on Springer fiber)
