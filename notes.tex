...
\[
  \BR p_{\CN,*}\underline{\BQ}_{\tilde{\CN}} \simeq (\BR p_{*}\underline{\BQ}_{\tilde{\fg}})|_{\CN}. \quad (\mathrm{Spr} = \BR p_{\CN,*}\underline{\BQ}_{\tilde{\CN}}[\dim \CN] \ \textcolor{red}{The \ Springer \ sheaf})
\]
