...
\[
  \BR p_{\CN,*}\underline{\BQ}_{\widetilde{\CN}} \simeq \BR p_{*}\underline{\BQ}_{\widetilde{\fg}})|_{\CN}. \quad  \statusnote{(\mathrm{Spr} = \BR p_{\CN,*}\underline{\BQ}_{\widetilde{\CN}}[\dim \CN] \ called \ The \ Springer \ sheaf)}
\]
...
\begin{thm}
  ...
  Then there are bijections between:
  \begin{itemize}
    \item irrducible $(\check{\fg}(\Lambda),K(y)^{alg})$-modules $M$ annihilated by $I_{\CP(\Lambda)}$ such that
      \[
