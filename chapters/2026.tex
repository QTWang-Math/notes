...
\section{2026.3.21 Geometry of the flag variety of \texorpdfstring{$\mathrm{SL}_2(\BC)$}{SL2(C)}}
...
\section{2026.3.22 Perverse sheaves on \texorpdfstring{$\BC$}{C}}
...
\section{2026.3.31 Enhanced flag variety and line bundles on \texorpdfstring{$\CB$}{B}}
...
\section{2026.4.5 Tangent map of the projection \texorpdfstring{$G \times^P V \to V$}{G x\string^P V to V}}
